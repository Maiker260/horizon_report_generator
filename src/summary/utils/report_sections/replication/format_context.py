...
def format_context(naming_context, neighbors, naming_context_max_width):
    ...
    if len(neighbors) == 1:
        return format_single_neighbor(naming_context, neighbors[0], naming_context_max_width)

    return format_multiple_neighbors(naming_context, neighbors, naming_context_max_width)